...
assert log.text.contains('Iface.java[7]: This package-private class "Simple" is not used anywhere in its package, delete it or make it public (UnusedPackagePrivateClassCheck)')
assert !log.text.contains('Violations.java[10]: This package-private class')
