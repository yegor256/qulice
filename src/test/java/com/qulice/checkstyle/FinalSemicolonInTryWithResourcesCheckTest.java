...
final class FinalSemicolonInTryWithResourcesCheckTest {
    ...
    @Test
    void rejectsExtraSemicolonInTryWithResources() throws Exception {
        final String file = "ExtraSemicolon.java";
        MatcherAssert.assertThat(
            "Extra semicolon in try-with-resources head must be reported",
